      ...
      <div className="container">
        <div className="calendar">
          ...
          <div className="month">
            ...
            <Link href="/Details">
              <Day value={"attendance"} day={week1[6]} week={1} mood={2} />
            </Link>
            <Link href="/Details">
              <Day value={"attendance"} day={week2[0]} week={2} mood={5} />
            </Link>
            <Link href="/Details">
              <Day value={"attendance"} day={week2[1]} week={2} mood={3} />
            </Link>
            <Link href="/Details">
              <Day value={"attendance"} day={week2[2]} week={2} mood={1} />
            </Link>
            <Link href="/Details">
              <Day value={"attendance"} day={week2[3]} week={2} mood={4} />
            </Link>
            <Link href={"/Details"}>
              <Day value={"attendance"} day={week2[4]} week={2} mood={5} />
            </Link>
